...
const Footer = () => {
  const footerLinks = [
    { label: "About REACH Automotive Studio", path: "/about" },
    { label: "Benefits of REACH Automotive Studio", path: "/benefits" },
        ...
        <div className="grid md:grid-cols-3 gap-8">
          <div>
            <Link to="/" className="text-2xl font-bold mb-4 block w-fit">
              <span className="text-primary">REACH</span> Automotive Studio
            </Link>
            <p className="text-gray-300 max-w-md">
              The REACH Automotive Studio
            </p>
            ...
            <div className="mt-6 space-y-4">
              ...
              <div className="flex items-center gap-3">
                <img src={emailIcon} alt="Email contact for REACH Automotive Studio" className="w-8" />
              ...
              >
                <img src={whatsappIcon} alt="WhatsApp support for REACH Automotive Studio" className="w-8" />
                <span className="text-gray-300 text-lg">
                  +91 84592 78496
                </span>
              </a>
              ...
              >
                <img src={contactIcon} alt="Contact form link for REACH Automotive Studio" className="w-7" />
                <span className="text-gray-300 text-lg">
                  Write to Us
                </span>
              </a>
